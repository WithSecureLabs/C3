...
namespace FSecure
{
	...
	/// public static std::tuple<...> TupleTransform(T const&) method.
	/// Use Utils::MakeConversionTuple to create efficient tuple of value or references to members.
	/// ByteVector can declare its own versions of To/Size/From methods if it needs dedicated logic to serialize type.
