...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Build", b =>
                {
                    b.Property<ulong>("BuildId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Channel", b =>
                {
                    b.Property<ulong>("AgentId");
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Command", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Connector", b =>
                {
                    b.Property<ulong>("AgentId");
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Peripheral", b =>
                {
                    b.Property<ulong>("AgentId");
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Route", b =>
                {
                    b.Property<ulong>("AgentId");
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Gateway", b =>
                {
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Relay", b =>
                {
                    b.HasBaseType("MWR.C3.WebController.Models.Agent");
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.GatewayBuild", b =>
                {
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.RelayBuild", b =>
                {
                    b.HasBaseType("MWR.C3.WebController.Models.Build");
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Agent", b =>
                {
                    b.HasOne("MWR.C3.WebController.Models.Build", "Build")
                        .WithMany()
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Channel", b =>
                {
                    b.HasOne("MWR.C3.WebController.Models.Agent")
                        .WithMany("Channels")
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Connector", b =>
                {
                    b.HasOne("MWR.C3.WebController.Models.Gateway")
                        .WithMany("Connectors")
                        .HasForeignKey("AgentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("MWR.C3.WebController.Models.Relay", b =>
                {
                    ...
                    b.OwnsOne("MWR.C3.WebController.Models.HostInfo", "HostInfo", b1 =>
                        {
                            ...
                            b1.HasOne("MWR.C3.WebController.Models.Relay")
                                .WithOne("HostInfo")
                                .HasForeignKey("MWR.C3.WebController.Models.HostInfo", "RelayAgentId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
